...
| Jira (jira.atlassian.com) | [view](https://htmlpreview.github.io/?https://github.com/akshat1404/Specular/blob/main/reports/jira-real-app/report.html) · [PDF](https://akshat1404.github.io/Specular/reports/jira-real-app/summary.pdf) | real-app | 18.3/100 | 0 fail / 73 checked | Legacy `/projects/<KEY>/summary` pages resolve to a generic OS font stack, not "Atlassian Sans"; drift concentrates in older, unmigrated UI, not the homepage |
...
| Pinterest Business (business.pinterest.com) | [view](https://htmlpreview.github.io/?https://github.com/akshat1404/Specular/blob/main/reports/pinterest-real-app/report.html) · [PDF](https://akshat1404.github.io/Specular/reports/pinterest-real-app/summary.pdf) | real-app | 12.3/100 | 4 fail / 146 checked | Pinterest's proprietary "PinterestSansPro"/"PinterestUI" brand fonts used everywhere instead of the token's generic default; oversized hero typography (up to 78px) beyond the component scale |
